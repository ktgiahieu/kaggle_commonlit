...
my_model_dataset = 'commonlit-bert-large-cased-meanmax'
if is_kaggle:
    ...
    MODEL_CONFIG = '../input/bert-large-cased'
else: #colab
    repo_name = 'kaggle_commonlit'
    drive_name = 'Commonlit'
    model_save = 'bert_large_cased_meanmax'
