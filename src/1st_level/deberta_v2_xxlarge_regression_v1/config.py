...
if is_kaggle:
    ...
    my_model_dataset = 'commonlit-deberta-v2-xxlarge-regression-v1'
    ...
    MODEL_CONFIG = '../input/deberta-v2-xxlarge'
else: #colab
    repo_name = 'kaggle_commonlit'
    drive_name = 'Commonlit'
    model_save = 'deberta_v2_xxlarge_regression_v1'
    ...
    MODEL_CONFIG = 'microsoft/deberta-v2-xxlarge'
