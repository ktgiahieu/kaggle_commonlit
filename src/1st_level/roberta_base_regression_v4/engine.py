...
def train_fn(train_data_loader, valid_data_loader, model, optimizer, device, epoch, writer, model_path, scheduler=None):
    losses = utils.AverageMeter()


    EVAL_SCHEDULE = [(0.51, 140), (0.50, 40), (0.49, 8), (0.48, 4), (0.47, 2), (-1., 1)]
    best_val_rmse = None
    step = 0
    last_eval_step = 0
